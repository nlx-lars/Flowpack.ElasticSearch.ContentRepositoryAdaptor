            ...
            return [
                ...
                [
                    'script' => [
                        'lang' => 'painless',
                        'inline' => '
                            HashMap fulltext = ((ctx._source.containsKey("__fulltext") && ctx._source.__fulltext instanceof HashMap) ? ctx._source.__fulltext : new HashMap());
                            HashMap fulltextParts = ((ctx._source.containsKey("__fulltextParts") && ctx._source.__fulltext instanceof HashMap) ? ctx._source.__fulltextParts : new HashMap());
